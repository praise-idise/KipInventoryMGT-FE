...
export function TransferRequestDetailPage() {
    ...
    const canSubmitDraft = canWrite && (transferStatus === TRANSFER_REQUEST_STATUS.DRAFT || transferStatus === TRANSFER_REQUEST_STATUS.CHANGES_REQUESTED)
    const canDeleteDraft = canSubmitDraft
    const canCancel = canWrite && (transferStatus === TRANSFER_REQUEST_STATUS.PENDING_APPROVAL || transferStatus === TRANSFER_REQUEST_STATUS.APPROVED)
    const canDispatch = canWrite && transferStatus === TRANSFER_REQUEST_STATUS.APPROVED
    const canComplete = canWrite && transferStatus === TRANSFER_REQUEST_STATUS.IN_TRANSIT
