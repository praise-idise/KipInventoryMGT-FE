import {
    ArrowRightLeft, ClipboardCheck, CreditCard, Database, LayoutDashboard,
    Package, PackageMinus, PackagePlus, Scale,
    Settings, ShoppingCart, Truck, Users, Warehouse,
} from 'lucide-react'
...
export const navGroups: (NavItem | NavGroup)[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Users & Roles', to: '/app/users', icon: Users, roles: [APP_ROLES.ADMIN] },
            { label: 'Billing', to: '/app/billing', icon: CreditCard, roles: [APP_ROLES.ADMIN] },
